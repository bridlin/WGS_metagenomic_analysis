        ...
        for keys in dict_taxo_per_sample:
            if sample == keys:
                for item in dict_taxo_per_sample[keys]:
                    ...
                    seq_file1 = read_file_path + '/' + striped_sample + 'nonhuman_reads_dedup_5trimmed.1.fastq'
                    seq_file2 = read_file_path + '/' + striped_sample + 'nonhuman_reads_dedup_5trimmed.2.fastq'
